...
ngx_int_t ngx_http_vhost_traffic_status_display_set_main(
    ngx_http_request_t *r, ngx_buf_t *buf);
ngx_int_t ngx_http_vhost_traffic_status_display_set_server_node(
    ngx_http_request_t *r,
    ngx_buf_t *buf, ngx_str_t *key,
    ngx_http_vhost_traffic_status_node_t *vtsn);
ngx_int_t ngx_http_vhost_traffic_status_display_set_server(
    ngx_http_request_t *r, ngx_buf_t *buf,
    ngx_rbtree_node_t *node);
ngx_int_t ngx_http_vhost_traffic_status_display_set_filter_node(
    ngx_http_request_t *r, ngx_buf_t *buf,
    ngx_http_vhost_traffic_status_node_t *vtsn);
ngx_int_t ngx_http_vhost_traffic_status_display_set_filter(
    ngx_http_request_t *r, ngx_buf_t *buf,
    ngx_rbtree_node_t *node);
ngx_int_t ngx_http_vhost_traffic_status_display_set_upstream_node(
    ngx_http_request_t *r, ngx_buf_t *buf,
...
ngx_int_t ngx_http_vhost_traffic_status_display_set_upstream_alone(
    ngx_http_request_t *r, ngx_buf_t *buf, ngx_rbtree_node_t *node);
ngx_int_t ngx_http_vhost_traffic_status_display_set_upstream_group(
    ngx_http_request_t *r, ngx_buf_t *buf);

#if (NGX_HTTP_CACHE)
ngx_int_t ngx_http_vhost_traffic_status_display_set_cache_node(
    ngx_http_request_t *r, ngx_buf_t *buf,
    ngx_http_vhost_traffic_status_node_t *vtsn);
ngx_int_t ngx_http_vhost_traffic_status_display_set_cache(
    ngx_http_request_t *r, ngx_buf_t *buf,
    ngx_rbtree_node_t *node);
#endif

ngx_int_t ngx_http_vhost_traffic_status_display_set(ngx_http_request_t *r,
    ngx_buf_t *buf);
